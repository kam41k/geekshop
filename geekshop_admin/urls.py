...
from geekshop_admin.views import admin, admin_users_create, AdminUsersListView, admin_users_update, admin_users_delete, \
...
urlpatterns = [
    ...
    path('admin-users-update/<int:pk>/', admin_users_update, name='admin-users-update'),
    path('admin-users-delete/<int:pk>/', admin_users_delete, name='admin-users-delete'),
